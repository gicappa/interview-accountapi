...
func TestCreate_account_GB(t *testing.T) {
	...
	account, _ := client.Create("GB", "GPB", "400300", "GBDSC", "NWBKGB22", "IT60X0542811101000000123456")
...
func TestCreate_account_GB_with_error(t *testing.T) {
	...
	_, err := client.Create("??", "GPB", "400300", "GBDSC", "NWBKGB22", "IT60X0542811101000000123456")
...
func TestCreate_account_unmarshal_json_in_response(t *testing.T) {
	...
	account, _ := client.Create("GB", "GPB", "400300", "GBDSC", "NWBKGB22", "GB11NWBK40030041426819")
...
func TestCreate_account_marshal_json_in_request(t *testing.T) {
	...
	client.Create("GB", "GPB", "400300", "GBDSC", "NWBKGB22", "GB11NWBK40030041426819")
